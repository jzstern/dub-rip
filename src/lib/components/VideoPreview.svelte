...
<div class="preview-card flex items-center gap-3 rounded-md border border-chrome-cyan/25 bg-background/40 p-3 shadow-[0_0_16px_-8px_hsl(var(--chrome-cyan)/0.6)]">
	<div class="relative h-12 w-12 flex-shrink-0 overflow-hidden rounded bg-muted ring-1 ring-chrome-magenta/30">
		<img
			src={imageSrc}
			alt={preview.title}
